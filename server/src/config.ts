...
export class Config {
  ...
  'server.port' = '8081';
  'jhipster.clientApp.name' = 'todoapp';
  ...
  'jhipster.mail.from' = 'todoapp@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'todoapp API';
  'jhipster.swagger.description' = 'todoapp API documentation';
  ...
  'eureka.instance.appname' = 'todoapp';
  'eureka.instance.instanceId' = 'todoapp:${random.value}';
